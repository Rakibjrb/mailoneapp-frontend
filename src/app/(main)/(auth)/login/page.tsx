...
import { GoogleOutlined, MailOutlined, LockOutlined, ArrowLeftOutlined } from "@ant-design/icons";
...
export default function LoginPage(): JSX.Element {
    ...
    return (
        ...
        >
            <div className="min-h-[calc(100vh-80px)] flex items-center justify-center px-4 relative overflow-hidden py-20">
                ...
                <div className="w-full max-w-[500px] relative z-10">
                    ...
                    <Link
                        href="/"
                        className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors mb-8 w-fit group"
                    >
